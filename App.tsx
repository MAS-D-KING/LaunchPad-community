...
const App: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full flex flex-col md:flex-row font-sans bg-beige-50 dark:bg-charcoal-900 transition-colors duration-300 overflow-hidden relative">
      ...
      {/* Mobile Header */}
      <div className="md:hidden flex items-center justify-between p-4 bg-white dark:bg-charcoal-800 border-b border-gray-200 dark:border-charcoal-700 shrink-0 z-30 relative">
      ...
      <aside className={`
        ...
        ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static h-full flex flex-col shadow-lg md:shadow-none
      `}>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-charcoal-700 bg-beige-50 dark:bg-charcoal-900/50">
           <button 
